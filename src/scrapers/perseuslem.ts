...
export class PerseusLemScraper extends Scraper {


	async getEntry(query:string): Promise<string | null> {
		try {

			var text = await super.getEntry('https://www.perseus.tufts.edu/hopper/text\?doc\=Perseus%3Atext%3A1999.04.0060%3Aentry%3D'+query);
